...
<footer>
    ...
    <ul>
        <li>Email: info@Phones4Retail.com</li>
        <li>Telefoon: +31 (0)70 345 6789</li>
        <li>Instagram: Phones4Retail</li>
        <li>Facebook: Phones4Retail</li>
        <li>Adres: Brasserskade, 1234 AB Den Haag, Nederland</li>
        <li><img src="img/routekaart.png" class="routekaart"> </li>
    </ul>
    <p>&copy; 2025 Phones4Retail</p>
</footer>
</body>
</html>